...
const ynOptionsReverse: AnswerOption[] = [
  { label: 'Yes', value: 'Y', risk: 'low' },
  { label: 'No', value: 'N', risk: 'high' },
];

const ynOptionsNormal: AnswerOption[] = [
  { label: 'Yes', value: 'Y', risk: 'high' },
  { label: 'No', value: 'N', risk: 'low' },
];
...
export const dimensions: Dimension[] = [
  {
    ...
    questions: [
      ...
      { id: 'D1.2', text: 'How many decisions did the owner make in the past week that were under 50K THB?', answerType: 'number',
        ...
        options: [
          { label: 'None (0)', value: '0', risk: 'low' },
          { label: '1–5', value: '3', risk: 'low' },
          { label: '6–10', value: '8', risk: 'medium' },
          { label: '11–20', value: '15', risk: 'high' },
          { label: '21+', value: '25', risk: 'high' },
        ] },
  ...
  },
  {
    ...
    questions: [
      { id: 'D2.1', text: 'What % of top-10 client revenue is from clients who contact the owner\'s personal phone first?', answerType: 'number',
        ...
        options: [
          { label: '0–20%', value: '10', risk: 'low' },
          { label: '21–40%', value: '30', risk: 'low' },
          { label: '41–60%', value: '50', risk: 'medium' },
          { label: '61–80%', value: '70', risk: 'high' },
          { label: '81–100%', value: '90', risk: 'high' },
        ] },
      ...
      { id: 'D2.3', text: 'Who closed the last 5 deals? (owner vs team)', answerType: 'number',
        ...
        options: [
          { label: '0 (team closed all)', value: '0', risk: 'low' },
          { label: '1 by owner', value: '1', risk: 'low' },
          { label: '2 by owner', value: '2', risk: 'medium' },
          { label: '3 by owner', value: '3', risk: 'high' },
          { label: '4–5 by owner', value: '5', risk: 'high' },
        ] },
      ...
      { id: 'D2.5', text: 'If the owner left, how many of the top 10 clients would likely leave within 12 months?', answerType: 'number',
        ...
        options: [
          { label: '0–1 clients', value: '1', risk: 'low' },
          { label: '2–3 clients', value: '3', risk: 'low' },
          { label: '4–5 clients', value: '5', risk: 'medium' },
          { label: '6–7 clients', value: '7', risk: 'high' },
          { label: '8–10 clients', value: '9', risk: 'high' },
        ] },
    ]
  },
  {
    ...
    questions: [
      ...
      { id: 'D3.3', text: 'How long does it take to onboard a new employee to be productive? (weeks)', answerType: 'number',
        ...
        options: [
          { label: '1–2 weeks', value: '2', risk: 'low' },
          { label: '3–4 weeks', value: '4', risk: 'low' },
          { label: '5–8 weeks', value: '6', risk: 'medium' },
          { label: '9–12 weeks', value: '10', risk: 'high' },
          { label: '13+ weeks', value: '15', risk: 'high' },
        ] },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: 'D4.3', text: 'How many critical system passwords are known only to the owner?', answerType: 'number',
        ...
        options: [
          { label: 'None (0)', value: '0', risk: 'low' },
          { label: '1–2', value: '2', risk: 'low' },
          { label: '3–5', value: '4', risk: 'medium' },
          { label: '6–10', value: '8', risk: 'high' },
          { label: '11+', value: '15', risk: 'high' },
        ] },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: 'D6.3', text: 'How many days after month-end are financials available?', answerType: 'number',
        ...
        options: [
          { label: '1–5 days', value: '3', risk: 'low' },
          { label: '6–10 days', value: '8', risk: 'low' },
          { label: '11–15 days', value: '13', risk: 'medium' },
          { label: '16–25 days', value: '20', risk: 'high' },
          { label: '26+ days', value: '30', risk: 'high' },
        ] },
